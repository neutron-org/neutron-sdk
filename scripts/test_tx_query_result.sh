...
RES=$(${BIN} tx bank send ${TEST_ADDR} ${QUERIES_CONTRACT_ADDRESS} 1000000stake --chain-id ${CHAIN_ID_1}  --broadcast-mode=block --gas-prices 0.0025stake -y --output json --keyring-backend test --home ${HOME_1} --node tcp://127.0.0.1:16657)
echo $RES
